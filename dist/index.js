...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PeopleViewModel = function () {
	  function PeopleViewModel() {
	    ...
	    _classCallCheck(this, PeopleViewModel);
	
	    //Inital data
	    this.people = _knockout2.default.observableArray([{ name: 'John Smith', amount: 12.01 }, { name: 'Jeff Smithe', amount: 0.50 }, { name: 'Jarrod Smythe', amount: 1.00 }]);
	
	    //Bound remove to the constructor as $parent changes the context of this in ES6 classes.
	    this.removePerson = function (value) {
	      _this.people.remove(value);
	    };
	  }
	
	  _createClass(PeopleViewModel, [{
	    key: 'addPerson',
	...
	_knockout2.default.applyBindings(new PeopleViewModel());
